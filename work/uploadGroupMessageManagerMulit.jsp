				...
				if(Title==null) Title="멀티메시지";
					...
					if(Title.equals(""))Title="멀티메시지";
						...
						for(int j=0; j<Title.length(); j++){
							if(Title.charAt(j)==CheckString1.charAt(0)) Title+="\\";
							if(Title.charAt(j)==CheckString2.charAt(0)) Title+="\\'";
							else tmpMSG+=Title.charAt(j);
						}
...
<script type="text/javascript">		 
	...
	window.setTimeout("location='<%=pathtalkfile.getTalkURLPath()%>/manager/formGroupMessageMultiSelect.jsp'",1); //1ms후 페이지 자동이동
</script>

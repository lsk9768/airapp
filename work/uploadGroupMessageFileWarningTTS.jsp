...
<%
	...
	String groupid = request.getParameter("groupid");         //그룹아이디
  	String MsgType = "1";       //발송업무 0:일반 1:경보
	...
	String AreaType = request.getParameter("AreaType");  // 일반 : 0 권역 :1
	String fileName = "";
	String file_name = "";
					...
					for(int l=0; l<GroupMaxCount; l=l+50){
						...
						if(l==0){
							...
							if(admin.checkSMS(sms_id)<=0){
								...
								if(admin.checkSMSMessage(sms_id)<=0)admin.insertSMSMessage(group_id,userid,"warning1",txtMsg+"|||"+file_name,sms_id);

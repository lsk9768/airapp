...
String MsgType = "1";      //발송업무 0:일반 1:경보 2:방송
	...
	if(userid!=null&&!userid.equals("")){
		...
		for(int m=0; m<maxcount; m=m+50){
					...
					for(int l=0; l<GroupMaxCount; l=l+50){
						...
						if(l==0){
							...
							if(admin.checkSMS(sms_id)<=0){
								...
								if(admin.checkSMSMessage(sms_id)<=0)admin.insertSMSMessage(group_id,userid,"warning3",msg+"|||"+file_name,sms_id);
						...
						for(int k=0; k<vctGroupMember.size(); k++){
							...
							infoSMS.send_msg_type = "warning3";	
          ...
          <script type="text/javascript">
			...
			window.setTimeout("location='<%=pathtalkfile.getTalkURLPath()%>/admin/formGroupAlert.jsp'",1); //1ms후 페이지 자동이동
			</script>
          <%
		 //out.print("2"); 
